        ...
        >
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="text.secondary" paragraph>
              Something short and leading about the collections below—its contents,
            ...
            >
              <Button variant="contained" style={{background:'#884aea'}}>Connect Polygon Wallet</Button>
              <Button variant="contained" style={{background:'#000000', color:'#ffffff'}}>Connect Solana Wallet</Button>
            </Stack>
          </Container>
        </Box>
